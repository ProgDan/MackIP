'**********************************************************
'**  Mackenzie Video Player Application - Show Feed 
'**  October 2013
'**********************************************************
...
'        item.HDPosterUrl           = item.hdImg
        ...
        item.HDPosterUrl           = "http://mini.progdan.com/roku/artwork/"+http.Escape(item.Title)+".png"
'        item.SDPosterUrl           = item.sdImg
        item.SDPosterUrl           = http.Escape("http://mini.progdan.com/roku/artwork/"+item.Title+".png")
